...
async def get_dashboard_stats(current_user: dict = Depends(get_current_user)):
    ...
    async for doc in db.inventory.aggregate([
        ...
        top_by_value.append({
            ...
            "stock_value": doc.get("stock_value", 0),
        })
    ...
    async for doc in db.sales_orders.aggregate([
        ...
        monthly_revenue.append({"month": doc["_id"], "revenue": doc["revenue"], "orders": doc["orders"]})
    ...
    async for doc in db.purchase_orders.aggregate([
        ...
        po_status_dist.append({"status": doc["_id"], "count": doc["count"], "total": doc["total"]})
